...
class ntPost {
    ...
    public function __construct(){
        ...
        add_action('ux_builder_setup', array($this, 'builder'));
		add_shortcode("nt_post", array($this,"display"));
    }
    ...
    public function builder() {
        include(NT_DIR_THEM_CHILD_INC . '/ntpost/ntpost-admin.php');
    }
    ...
    while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
            ...
            include(NT_DIR_THEM_CHILD_INC . '/ntpost/ntpost-frontend.php');
    endwhile;
    wp_reset_query();
