...
<div id="top-bar" class="header-top <?php header_inner_class('top'); ?>">
    <div class="flex-row container">
      <div class="flex-col hide-for-medium flex-left">
          <ul class="nav top-bar-nav nav-left medium-nav-center nav-small <?php flatsome_nav_classes('top'); ?>">
              <?php flatsome_header_elements('topbar_elements_left'); ?>
          </ul>
      </div>

      <div class="flex-col hide-for-medium flex-center">
          <ul class="nav top-bar-nav nav-center nav-small <?php flatsome_nav_classes('top'); ?>">
      ...
      <div class="flex-col show-for-medium flex-grow">
          <ul class="nav top-bar-nav nav-center nav-small mobile-nav <?php flatsome_nav_classes('top'); ?>">
