<div class="entry-content">
	...
	<div class="entry-summary">
		...
		<div class="text-<?php echo get_theme_mod( 'blog_posts_title_align', 'center' );?>">
			<a class="more-link button secondary is-bevel is-smaller" href="<?php echo get_the_permalink(); ?>"><?php _e('Continue reading <span class="meta-nav">&rarr;</span>', 'flatsome'); ?></a>
		</div>
	</div>
	<?php } else { ?>
