...
add_shortcode('tgb_header_mb', function () {
    ...
    $header_settings = get_field('header_settings', 'option') ?? [];
    $menu_mobile = $header_settings['menu_mobile'] ?? null;
    $promotion = ($menu_mobile && $menu_mobile['promotion']) ? $menu_mobile['promotion'] : '#';
    $livestream = ($menu_mobile && $menu_mobile['livestream']) ? $menu_mobile['livestream'] : '#';
?>
    <div class="tgb_header_mb">
        ...
        if ($list_category):
        ?>
            <div class="header_mb_list_cat">
                <div class="heading">
                    <div class="text">
                        Danh mục
                    </div>
                    <div class="icon" id="header_mb_list_cat_close">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            <div class="list">
                <div class="grid_row">
                    ...
                    <div class="col_custom">
                        <div class="item" id="mb_header_item_cat">
                            <div class="icon">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col_custom">
                        <a href="<?php echo $promotion; ?>" class="item">
                            <div class="icon">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col_custom">
                        <a href="<?php echo $livestream; ?>" class="item">
                            <div class="icon">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col_custom">
                        <a href="<?php echo wc_get_cart_url(); ?>" class="item">
                            <div class="icon">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
