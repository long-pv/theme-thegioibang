...
add_action('wp_enqueue_scripts', function () {
    // slick
    wp_enqueue_style('tgb-style-slick-theme', TGB_SHORTCODE_PATH . '/assets/slick/slick-theme.css', array(), '1.0.0');
    wp_enqueue_style('tgb-style-slick', TGB_SHORTCODE_PATH . '/assets/slick/slick.css', array(), '1.0.0');
    wp_enqueue_script('tgb-script-slick', TGB_SHORTCODE_PATH . '/assets/slick/slick.min.js', array('jquery'), '1.0.0', true);
